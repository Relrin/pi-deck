  ...
  return (
    <RadixDialog.Root open={open} onOpenChange={onOpenChange}>
      <RadixDialog.Portal>
        ...
        <RadixDialog.Content className="fixed left-1/2 top-1/2 z-50 -translate-x-1/2 -translate-y-1/2 w-[min(28rem,90vw)] rounded-[var(--radius-lg)] bg-[var(--color-panel)] border border-[var(--color-border)] p-5 shadow-xl">
