...
mock.module("./TerminalRenderer.js", () => ({
...
const { render, act } = await import("../../../test/utils");
const { TerminalView } = await import("./TerminalView");
const { useSessionsStore } = await import("../sessions/useSessionsStore");
const { encodeBase64Utf8, dispatchTerminalOutput } = await import("./terminalOutput");
