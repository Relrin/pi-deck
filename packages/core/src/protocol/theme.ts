...
const tokens = {
  ...
  "syn-keyword": tokenString.optional(),
  "syn-string": tokenString.optional(),
  "syn-regexp": tokenString.optional(),
  "syn-comment": tokenString.optional(),
  "syn-doc-comment": tokenString.optional(),
  "syn-comment-style": tokenString.optional(),
  "syn-number": tokenString.optional(),
  "syn-constant": tokenString.optional(),
  "syn-type": tokenString.optional(),
  "syn-class": tokenString.optional(),
  "syn-function": tokenString.optional(),
  "syn-macro": tokenString.optional(),
  "syn-variable": tokenString.optional(),
  "syn-parameter": tokenString.optional(),
  "syn-property": tokenString.optional(),
  "syn-attribute": tokenString.optional(),
  "syn-tag": tokenString.optional(),
  "syn-operator": tokenString.optional(),
  "syn-punctuation": tokenString.optional(),
  "syn-meta": tokenString.optional(),
  "syn-link": tokenString.optional(),
  "syn-heading": tokenString.optional(),
  "syn-invalid": tokenString.optional(),

  "term-black": tokenString.optional(),
  "term-red": tokenString.optional(),
  "term-green": tokenString.optional(),
  "term-yellow": tokenString.optional(),
  "term-blue": tokenString.optional(),
  "term-magenta": tokenString.optional(),
  "term-cyan": tokenString.optional(),
  "term-white": tokenString.optional(),
  "term-bright-black": tokenString.optional(),
  "term-bright-red": tokenString.optional(),
  "term-bright-green": tokenString.optional(),
  "term-bright-yellow": tokenString.optional(),
  "term-bright-blue": tokenString.optional(),
  "term-bright-magenta": tokenString.optional(),
  "term-bright-cyan": tokenString.optional(),
  "term-bright-white": tokenString.optional(),
