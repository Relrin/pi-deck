...
- **Glyph system** — `packages/ui/src/components/glyph/`. Custom dot-grid SVGs ported from the design mockup. All new `Pid*` components use `<Glyph>`; `lucide-react` survives only in legacy files until plan 015.
